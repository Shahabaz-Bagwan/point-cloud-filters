...
private:
	...
	struct cloud_point_index_idx
	{
		...
		cloud_point_index_idx(size_t idx_, size_t cloud_point_index_) : idx(idx_), cloud_point_index(cloud_point_index_) {}
		bool operator < (const cloud_point_index_idx &p) const { return (idx < p.idx); }
	};

	std::pair<double, double> x_limits, y_limits, z_limits;
	bool x_passthough_limits_set, y_passthough_limits_set, z_passthough_limits_set;
